# 도시 배경 텍스처 일괄 임포트 — RawAssets/CityBg/<id>.jpg → /Game/CityBg/T_<id>
import unreal, os

RAW_DIR = unreal.Paths.project_dir() + "RawAssets/CityBg"
PKG = "/Game/CityBg"
...
with open(r"C:/Users/Public/WCUE/citybg_out.txt", "w") as out:
