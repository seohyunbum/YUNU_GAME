...
> **문서 버전**: v1.6 (2026-07-17) — 개정 이력: v1.0 최초 작성 · v1.1 §5.6 밸런스 편집 도구 · v1.2 §2.7 시네마틱 + §2.8 초빙(가챠) 신설 · v1.3 §4.4 결정론 개정 승인(명명 RNG 스트림+PCG32) + 일기토(§2.6) 구현 확정 — 관련 종속·미확정 항목 해소 · v1.4 §7 즉시 묶음 — §0.3 커밋·검증 규율(6·7), §4.2 SaveSystem 계약, §4.4 정수 산술 표준, §5.5 스키마 버전·콘텐츠 id 생애주기, §8 세이브 roundtrip·해석기 방어, §9 갭 리스크 6행 · v1.5 미확정 결정 반영 — 페이크아웃 미채택·T3캡 5 확정·AI영상 배제·선물 pity 전진 허용·천장/비용 현재값 유지+패널 조정(§5.6 편집 그룹 5종) · v1.6 §2.3.1 내정 상세 확정 — 태수 스탯 연동(정치→생산·건설, 매력→민심·징병, 지력→기술)·민심 승수·세율 3단계·인구 징병·반란·시설 6종(시장/농지/항구/학당/병영/성벽); 병행 세션 tech 안 통합; data schema_version 2
