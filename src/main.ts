...
import { createTelegraphField, updateTelegraphField, spawnFieldTelegraph, clearTelegraphField, type TelegraphField, type TelegraphFieldVfx } from "./game/telegraph"; // 일리아식 범위 예고 — 오버월드 보스/용 공유 중앙 필드
