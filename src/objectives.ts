...
export const TUTORIAL_STEPS: readonly TutorialStep[] = [
  ...
  checkQuest("get_smelter", (s) => s.hasSmelter || s.countItem("smelter") > 0, "제련대 구하기", "제련대는 상자에서 낮은 확률로 나오거나, 마을 포인트 상점에서 2600P에 살 수 있습니다. 제련대가 있어야 철을 제련할 수 있습니다.", { experience: 200, items: { coal: 6 }, label: "경험치 200 + 석탄 6개" }),
