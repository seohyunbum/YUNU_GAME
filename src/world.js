...
(function (L) {
  ...
  const REGIONS = [
    ...
    region({
      ...
      build: { kind: 'desert' },
      spawn: { types: ['golem', 'slime', 'bat'], max: 10, near: 48, far: 100 },
    ...
    region({
      ...
      particles: 'dust',
      spawn: { types: ['toxic', 'toxic', 'wisp', 'zombie'], max: 12, near: 44, far: 94 },
    ...
    region({
      ...
      build: { kind: 'sewer' },
      particles: 'dust',
      spawn: { types: ['toxic', 'zombie', 'bat'], max: 11, near: 42, far: 88 },
    ...
    region({
      ...
      spawn: { types: ['zombie', 'wisp', 'crystal'], max: 10, near: 46, far: 96 },
    ...
    region({
      ...
      spawn: { types: ['wisp', 'crystal', 'zombie', 'toxic'], max: 11, near: 46, far: 96 },
    ...
    region({
      ...
      build: { kind: 'lava' },
      spawn: { types: ['golem', 'crystal', 'ice'], max: 10, near: 46, far: 96 },
    ...
    region({
      ...
      spawn: { types: ['golem', 'slime', 'zombie'], max: 10, near: 46, far: 96 },
    ...
    region({
      ...
      spawn: { types: ['toxic', 'wisp', 'zombie'], max: 11, near: 46, far: 96 },
    ...
    region({
      ...
      spawn: { types: ['zombie', 'zombie', 'wisp'], max: 12, near: 42, far: 88 },
    ...
    region({
      ...
      build: { kind: 'museum' },
      spawn: { types: ['wisp', 'wisp', 'zombie'], max: 10, near: 42, far: 88 },
    ...
    region({
      ...
      build: { kind: 'haunted' },
      boss: { type: 'wisp', name: '큰 도깨비불', scale: 3.2, hpMul: 8, speedMul: 0.7 },
      particles: 'firefly',
      spawn: { types: ['wisp', 'zombie', 'bat'], max: 11, near: 42, far: 88 },
    ...
    region({
      ...
      particles: 'dust',
      spawn: { types: ['toxic', 'toxic', 'zombie', 'crystal'], max: 12, near: 44, far: 92 },
    ...
    region({
      ...
      spawn: { types: ['zombie', 'zombie', 'toxic', 'wisp'], max: 13, near: 44, far: 92 },
      height: B.mesa({ top: 8, r: 270, pad: 140 }),
      color: B.paint(PAL.CONCRETE, { slope: PAL.ROCK }),
    ...
    region({
      ...
      spawn: { types: ['zombie', 'crystal', 'toxic'], max: 12, near: 44, far: 92 },
    ...
    region({
      ...
      spawn: { types: ['zombie', 'zombie', 'zombie', 'toxic'], max: 14, near: 42, far: 88 },
      height: B.mesa({ top: 6, r: 250, pad: 130 }),
      color: B.paint(PAL.WASTE, { slope: PAL.CONCRETE }),
      ambience: B.AMB.toxic,
    }),
    ...
    region({
      ...
      spawn: { types: ['zombie', 'crystal', 'wisp'], max: 11, near: 44, far: 92 },
    ...
    region({
      ...
      spawn: { types: ['golem', 'zombie', 'toxic'], max: 11, near: 44, far: 92 },
      height: B.mesa({ top: 7, r: 240, pad: 130 }),
      color: B.paint(PAL.CONCRETE, { slope: PAL.ROCK }),
      ambience: B.AMB.facility,
    }),
    region({
      ...
      spawn: { types: ['crystal', 'zombie', 'wisp', 'toxic'], max: 12, near: 44, far: 92 },
    ...
    region({
      ...
      spawn: { types: ['toxic', 'crystal', 'zombie'], max: 12, near: 44, far: 92 },
      height: B.mesa({ top: 7, r: 240, pad: 130 }),
      color: B.paint(PAL.CONCRETE, { slope: PAL.ROCK }),
      ambience: B.AMB.facility,
    }),
    region({
      ...
      spawn: { types: ['wisp', 'crystal', 'zombie'], max: 12, near: 44, far: 92 },
      height: B.mesa({ top: 8, r: 240, pad: 130 }),
      color: B.paint(PAL.CONCRETE, { slope: PAL.ROCK }),
    ...
    region({
      ...
      spawn: { types: ['crystal', 'wisp', 'toxic'], max: 12, near: 44, far: 92 },
      height: B.mesa({ top: 7, r: 240, pad: 130 }),
      color: B.paint(PAL.CONCRETE, { slope: PAL.ROCK }),
      ambience: B.AMB.facility,
    }),
    region({
      ...
      spawn: { types: ['toxic', 'golem', 'zombie'], max: 12, near: 44, far: 92 },
      height: B.mesa({ top: 7, r: 240, pad: 130 }),
      color: B.paint(PAL.CONCRETE, { slope: PAL.ROCK }),
      ambience: B.AMB.facility,
    }),
    region({
      ...
      spawn: { types: ['zombie', 'crystal', 'golem'], max: 12, near: 44, far: 92 },
      height: B.mesa({ top: 7, r: 240, pad: 130 }),
      color: B.paint(PAL.CONCRETE, { slope: PAL.DARKROCK }),
      ambience: B.AMB.facility,
    }),
