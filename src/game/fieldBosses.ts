...
export const FIELD_BOSSES: readonly FieldBossDef[] = [
  ...
  { id: "boss_mushroom_glen", mapId: "mushroom_glen", name: "곰 족장", monsterId: "bear", level: 53, scale: 2.0, tint: 0xa21caf, position: [165, 190], rewardExperience: 800, rewardItems: { diamond: 2, medkit: 3 }, rewardLabel: "경험치 800 + 다이아몬드 2개 + 구급상자 3개" },
  ...
  { id: "boss_graveyard", mapId: "graveyard", name: "좀비 군주", monsterId: "zombie", level: 93, scale: 2.2, tint: 0x365314, position: [150, -130], rewardExperience: 1600, rewardItems: { obsidian: 4, medkit: 5 }, rewardLabel: "경험치 1600 + 흑요석 4개 + 구급상자 5개" },
