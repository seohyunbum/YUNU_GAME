...
> = {
  ...
  samurai: {
    name: "사무라이",
    tagline: "리치 긴 카타나와 빠른 검격으로 몰아치는 신속 근접 직업",
    starterItem: "katana",
    skillName: "난도",
    skillSummary: `마나 ${SAMURAI_SKILL_COST}로 전방의 적을 재빠르게 4연격합니다. (쿨다운 ${SAMURAI_SKILL_COOLDOWN}초)`,
    manaCost: SAMURAI_SKILL_COST,
    cooldown: SAMURAI_SKILL_COOLDOWN,
  },
  tanker: {
    name: "탱커",
