...
const EXTRA_NOTES: Partial<Record<ItemId, string>> = {
  ...
  dragon_gloves: "용 장비(최고등급). 가방에 있으면 자동 착용. 공격력 +10 · 공격속도 +10%. 확장 제작대에서만 제작.",
  dragon_boots: "용 장비(최고등급). 가방에 있으면 자동 착용. 이동속도 +15% · 최대 체력·마나 +10. 확장 제작대에서만 제작.",
  dragon_cloak: "용 장비(최고등급). 가방에 있으면 자동 착용. 방어력 +10 · 초당 체력 회복 +2. 확장 제작대에서만 제작.",
  dragon_crown: "용 장비(최고등급). 가방에 있으면 자동 착용. 스킬 쿨타임 -10% · 초당 마나 회복 +2. 확장 제작대에서만 제작.",
  job_change_tome: "전직의서. 몬스터 동굴 보스와 몬스터 요새(디펜스)에서 얻는 에픽 재료입니다. 제작대에서 전직 아이템(전직의 표식·각서)을 만드는 데 씁니다.",
  // 전직 표식·각서·상급 각서는 제작 아이템 → 설명은 레시피 note(RECIPE_NOTES)가 단일 출처. 여기 중복 정의 금지.
