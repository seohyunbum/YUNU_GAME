...
const EXTRA_NOTES: Partial<Record<ItemId, string>> = {
  ...
  job_change_tome: "전직의서. 몬스터 동굴 보스와 몬스터 요새(디펜스)에서 얻는 에픽 재료입니다. 제작대에서 '전직의 인장'을 만드는 데 씁니다.",
  job_seal: "전직의 인장. 전직의서로 제작합니다. 레벨이 충분하면(1차 30·2차 50·3차 70) 들고 사용해 다음 차수로 전직합니다. 1차엔 새 스킬(F), 차수마다 스탯↑·쿨다운↓·새 외형. 차수가 오를수록 인장이 더 필요합니다.",
