...
export const WORKBENCH_RECIPES: Recipe[] = [
  ...
  {
    id: "job_decree_ultimate_strength",
    name: "최상급 전직의 각서 (힘)",
    output: "job_decree_ultimate_strength",
    count: 1,
    ingredients: { job_decree_high: 1, job_decree: 3, job_seal: 7, job_change_tome: 15, dragon_tail: 5, dragon_scale: 15, dragon_horn: 2, strength_necklace: 1 },
    note: "확장 제작대 전용 · 신화 등급(최상위). 4차(초월) 전직 아이템입니다. 레벨 100 이상에서 들고 사용하면 4차 전직 — 새 스킬·상시 반격·전 능력치 +10%·기존 스킬 +10%, 그리고 재료 '힘의 목걸이' 효과(공격력)가 영구히 추가됩니다.",
    extendedOnly: true,
  },
  {
    id: "job_decree_ultimate_guardian",
    name: "최상급 전직의 각서 (수호)",
    output: "job_decree_ultimate_guardian",
    count: 1,
    ingredients: { job_decree_high: 1, job_decree: 3, job_seal: 7, job_change_tome: 15, dragon_tail: 5, dragon_scale: 15, dragon_horn: 2, guardian_necklace: 1 },
    note: "확장 제작대 전용 · 신화 등급(최상위). 4차(초월) 전직 아이템입니다. 레벨 100 이상에서 들고 사용하면 4차 전직 — 새 스킬·상시 반격·전 능력치 +10%·기존 스킬 +10%, 그리고 재료 '수호의 목걸이' 효과(방어력)가 영구히 추가됩니다.",
    extendedOnly: true,
  },
  {
    id: "job_decree_ultimate_swift",
    name: "최상급 전직의 각서 (쾌속)",
    output: "job_decree_ultimate_swift",
    count: 1,
    ingredients: { job_decree_high: 1, job_decree: 3, job_seal: 7, job_change_tome: 15, dragon_tail: 5, dragon_scale: 15, dragon_horn: 2, swift_necklace: 1 },
    note: "확장 제작대 전용 · 신화 등급(최상위). 4차(초월) 전직 아이템입니다. 레벨 100 이상에서 들고 사용하면 4차 전직 — 새 스킬·상시 반격·전 능력치 +10%·기존 스킬 +10%, 그리고 재료 '쾌속의 목걸이' 효과(공격속도)가 영구히 추가됩니다.",
    extendedOnly: true,
  },
  {
    id: "job_decree_ultimate_sage",
    name: "최상급 전직의 각서 (현자)",
    output: "job_decree_ultimate_sage",
    count: 1,
    ingredients: { job_decree_high: 1, job_decree: 3, job_seal: 7, job_change_tome: 15, dragon_tail: 5, dragon_scale: 15, dragon_horn: 2, sage_necklace: 1 },
    note: "확장 제작대 전용 · 신화 등급(최상위). 4차(초월) 전직 아이템입니다. 레벨 100 이상에서 들고 사용하면 4차 전직 — 새 스킬·상시 반격·전 능력치 +10%·기존 스킬 +10%, 그리고 재료 '현자의 목걸이' 효과(스킬 쿨다운·마나 회복)가 영구히 추가됩니다.",
    extendedOnly: true,
  },
  {
    id: "dragon_spawn",
