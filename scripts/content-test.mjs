...
try {
  ...
  // 아이템 5단계 등급(itemTier): 모든 아이템이 유효 등급으로 분류되고, 앵커 아이템 등급이 기준과 일치
  {
    ...
    // 레전더리 = 최종 흑요석 무기 3종 + 상급 전직의 각서 + 경험치병
    const legendary = Object.keys(ITEM_NAMES).filter((id) => itemTier(id) === "legendary").sort();
    const expectedLegendary = ["job_decree_high", "job_seal", "sharp_obsidian_gun", "sharp_obsidian_shield", "sharp_obsidian_staff", "xp_bottle"];
